...
6. Surface the receipt in both the normal HUD and play summary: physics path, local resident word, imperfect gloss, component, body expression, save/return match, Start resident expression, and object-memory next action.
...
10. Show a public resident expression tied to the restored component and consumed `Objects` action, then surface it as a normal primary-surface/canvas cue.
