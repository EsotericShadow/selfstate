...
- [SSRM-3D open emergence sandbox](docs/90_ssrm_3d_open_emergence_sandbox.md): live non-canonical browser sandbox where agents start from traits, use generic primitives such as inspect, harvest, construct, repair, modify, strike, and signal, form inferred specializations, carry lifecycle cost, reproduce abstractly, care for dependents, age, and die under world pressure.
