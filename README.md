...
- [SSRM-3D open emergence sandbox](docs/90_ssrm_3d_open_emergence_sandbox.md): live non-canonical browser sandbox where agents start from traits, discover affordances, form inferred specializations, use body-made sounds, carry lifecycle cost, reproduce abstractly, care for dependents, age, and die under world pressure.
