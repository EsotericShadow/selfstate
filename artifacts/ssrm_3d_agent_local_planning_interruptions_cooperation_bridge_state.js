window.SSRM_3D_AGENT_LOCAL_PLANNING_INTERRUPTION_COOPERATION_STATE = {
  ...
  "planning_state": {
    "agents": {
      "Ari": {
        ...
        "project_progress": 0.24,
        "public_plan": {
          "plan_id": "8bc99c7b37761310",
          "private_stack_hidden": true,
          "project_id": "repair_clay_latch_with_dry_patch",
          "step_count": 7,
          "summary": "Ari plans repair_clay_latch_with_dry_patch"
        },
        "relationship": {
          "felt_respect": 0.7450000000000001,
          "gratitude": 0.355,
          "trust_in_avatar": 0.7150000000000002,
          "wariness": 0.213
        },
        "self_story": [
      ...
      "Fay": {
        ...
        "project_progress": 0.24,
        "public_plan": {
          "plan_id": "2873991614279324",
          "private_stack_hidden": true,
          "project_id": "dry_cloak_and_moss_bedding_support",
          "step_count": 7,
          "summary": "Fay plans dry_cloak_and_moss_bedding_support"
        },
        "relationship": {
          "felt_respect": 0.89,
          "gratitude": 0.38500000000000006,
          "trust_in_avatar": 0.7350000000000002,
          "wariness": 0.13399999999999992
        },
        "self_story": [
      ...
      "Milo": {
        ...
        "project_progress": 0.24,
        "public_plan": {
          "plan_id": "c7d31453dc377b11",
          "private_stack_hidden": true,
          "project_id": "ridge_warning_route_clearance",
          "step_count": 7,
          "summary": "Milo plans ridge_warning_route_clearance"
        },
        "relationship": {
          "felt_respect": 0.67,
          "gratitude": 0.355,
          "trust_in_avatar": 0.7200000000000002,
          "wariness": 0.20799999999999988
        },
        "self_story": [
    ...
    "events": [
      {
        ...
        "dependency_packet": {
          ...
          "blocked_dependency": "dry_cloak_handoff",
          "resolved_dependency": null
        },
        "event_id": 0,
        ...
        "plan_index_after": 1,
        "plan_index_before": 0,
        "priority_replan_packet": null,
        "private_plan_hidden": true,
        "public_plan_summary": {
          "plan_id": "8bc99c7b37761310",
          "private_stack_hidden": true,
          "project_id": "repair_clay_latch_with_dry_patch",
      ...
      },
      {
        ...
        "dependency_packet": {
          ...
          "blocked_dependency": "reed_cup_ready",
          "resolved_dependency": null
        },
        "event_id": 1,
        "event_kind": "plan_step",
      ...
      },
      {
        ...
        "dependency_packet": {
          ...
          "blocked_dependency": "glass_lens_check",
          "resolved_dependency": null
        },
        "event_id": 2,
        "event_kind": "plan_step",
      ...
      },
      {
        ...
        "current_step": "collect_primary_object",
        "day": 0,
        "dependency_packet": {
          "all_dependencies": {
            "dry_cloak_handoff": {
      ...
      },
      {
        ...
        "cooperation_packet": {
          "accepted": true,
          "cooperation_kind": "handoff",
          "partners": [
            "Ari",
            "Fay"
          ]
        },
        "current_step": "resolve_dependency",
        "day": 0,
        "dependency_packet": {
          "all_dependencies": {
            "dry_cloak_handoff": {
          ...
          "blocked_dependency": "dry_cloak_handoff",
          "resolved_dependency": "dry_cloak_handoff"
        },
        "event_id": 9,
        "event_kind": "dependency_handoff",
        "flower_node": "return_petal",
        "frequency_hz": 0.219,
        "global_tick": 3,
        "handoff_packet": {
      ...
      },
      {
        ...
        "dependency_packet": {
          ...
          "blocked_dependency": "reed_cup_ready",
          "resolved_dependency": "reed_cup_ready"
        },
        "event_id": 10,
        "event_kind": "dependency_handoff",
      ...
      },
      {
        ...
        "dependency_packet": {
          ...
          "blocked_dependency": "glass_lens_check",
          "resolved_dependency": "ridge_route_signal"
        },
        "event_id": 11,
        "event_kind": "dependency_handoff",
        "flower_node": "social_petal",
        ...
        "handoff_packet": {
          ...
          "object": {
            ...
            "flower_node": "social_petal",
            "frequency_hz": 0.256,
            "handoff_for": "ridge_route_signal",
            "held_by": "Ari",
            "label": "signal shell",
            "last_used_by": "Milo",
            "need_targets": [
      ...
      },
      {
        ...
        "priority_replan_packet": {
          "inserted_step": "stabilize_and_rest",
          "priority": "safety_first",
          "replan_reason": "wet_squall"
        },
        "private_plan_hidden": true,
        "public_plan_summary": {
          "plan_id": "8bc99c7b37761310",
      ...
      },
      {
        ...
        "cooperation_packet": {
          "accepted": true,
          "cooperation_kind": "dependency_support",
          "partners": [
            "Fay",
            "Milo"
          ]
        },
        "current_step": "cooperate",
        "day": 0,
        "dependency_packet": {
          "all_dependencies": {
            "dry_cloak_handoff": {
      ...
      },
      {
        ...
        "dependency_packet": {
          ...
          "blocked_dependency": "glass_lens_check",
          "resolved_dependency": "glass_lens_check"
        },
        "event_id": 17,
        "event_kind": "cooperation_step",
      ...
      },
      {
        ...
        "priority_replan_packet": {
          "inserted_step": "stabilize_and_rest",
          "priority": "safety_first",
          "replan_reason": "missing_dependency"
        },
        "private_plan_hidden": true,
        "public_plan_summary": {
          "plan_id": "8bc99c7b37761310",
        ...
        "replay_frame": {
          ...
          "dependency": null,
          "event_kind": "interruption_detected",
          "interruption": "missing_dependency",
          "place_after": "hearth_vale",
          "replay_index": 27,
          "tick": 3
        },
      ...
      },
      {
        ...
        "recovery_packet": {
          "resume_ok": true,
          "resumed_step": "stabilize_and_rest"
        },
        "replay_frame": {
          "agent_id": "Ari",
          "current_step": "stabilize_and_rest",
      ...
      },
      {
        ...
        "priority_replan_packet": {
          "inserted_step": "stabilize_and_rest",
          "priority": "safety_first",
          "replan_reason": "route_hazard_warning"
        },
        "private_plan_hidden": true,
        "public_plan_summary": {
          "plan_id": "8bc99c7b37761310",
        ...
        "replay_frame": {
          ...
          "dependency": null,
          "event_kind": "interruption_detected",
          "interruption": "route_hazard_warning",
          "place_after": "hearth_vale",
          "replay_index": 42,
          "tick": 2
        },
    ...
    "planning_kernel": {
      ...
      "private_plan_stack_hidden": true,
    ...
    "source_condition": "integrated_agent_routine_home_work_unscripted_object_use"
  },
  "source_condition": "integrated_agent_routine_home_work_unscripted_object_use",
  "trace_events": 72
};
