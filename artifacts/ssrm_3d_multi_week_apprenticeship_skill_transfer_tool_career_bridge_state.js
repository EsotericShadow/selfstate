window.SSRM_3D_MULTI_WEEK_APPRENTICESHIP_SKILL_TRANSFER_TOOL_CAREER_STATE = {
  "career_state": {
    "career_kernel": {
      "apprenticeship": true,
      "autonomy_growth": true,
      "browser_replay": true,
      "career_identity": true,
      "craft_quality": true,
      "fatigue_learning_balance": true,
      "frequency_flower_binding": true,
      "mentor_assignment": true,
      "name": "integrated_multi_week_apprenticeship_skill_transfer_tool_career",
      "privacy_filter": true,
      "project_role_fit": true,
      "schedule_memory_binding": true,
      "skill_practice": true,
      "skill_transfer": true,
      "teaching_lineage": true,
    ...
    "source_condition": "integrated_agent_led_settlement_work_social_project_schedule",
    "tools": {
      "path_chisel": {
        "lineage_marks": [
  ...
  "config": {
    "seed": 20260806,
    "source_state": "artifacts/ssrm_3d_agent_led_settlement_work_social_project_schedule_bridge_state.json",
    "weeks": 8
  },
  "moral_boundary": {
