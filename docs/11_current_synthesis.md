...
- SSRM-3D learned integration tests whether tool, social, continuity, and attention evidence move into recurrent policy state; current evidence is a designed packet bridge that still needs no-scenario-leakage, randomized-pressure, and multi-seed tests;
