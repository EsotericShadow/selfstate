...
- SSRM-3D long-horizon, multi-day maturation, learned/return-selected multi-day maturation, and hidden-regime adaptation tests whether 12h development, delayed shocks, births, teaching, infrastructure/tool development, risk memory, environmental sensing, social culture, closed-loop neural action selection, return-selected pressure routing, and noisy post-gate regime shifts survive headless multi-seed verification;
