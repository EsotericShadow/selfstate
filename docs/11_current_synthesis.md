...
The SSRM-3D tool-making, social, contract, threat, resource-ecology, injury/disability, development/skill, and dependent-care precursors add that self-state pressure is not only internal. External markers, shared tools, identity memory, reputation, costly signals, names, obligations, alarms, shelter, trace control, caches, restraint, territory access, capability compensation, competence history, fragile companions, promises, and care priority matter only when they preserve future options under embodied confusion, repeated social memory, delayed obligations, hostile tracking, delayed resource consequences, changed capability, changing competence, or another persistent agent's vulnerability.
...
- SSRM-3D persistent pressure layers from structured perception through dependent care;
