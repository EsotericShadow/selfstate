...
| Real social pressure | Partial pass. Return-selected SSRM-3D policies use identity memory, reputation, vulnerability, and shared-tool trust under cooperative repair, opportunist vulnerability, deceptive route, and shared-tool pressure. | Move social discovery into learned controllers and add richer repeated interaction, communication, deception, and resource conflict. |
