...
- SSRM-3D tool-making, social-pressure, and social-ecology testing showing that external tools, identity memory, reputation, and costly signals are selected only when they preserve future options.
