...
- SSRM-3D tool-making, social-pressure, social-ecology, social trust/contracts, predator/threat, resource-ecology, injury/disability, development/skill, and dependent-care testing showing that external tools, identity memory, reputation, commitments, costly signals, threat defenses, caches, restraint, territory, capability compensation, competence history, and fragile-companion care are selected only when they preserve future options.
