...
- SSRM-3D tool-making, social-pressure, social-ecology, social trust/contracts, predator/threat, resource-ecology, injury/disability, development/skill, dependent-care, and irreversible-loss testing showing that external tools, identity memory, reputation, commitments, costly signals, threat defenses, caches, restraint, territory, capability compensation, competence history, fragile-companion care, and loss response are selected only when they preserve future options.
