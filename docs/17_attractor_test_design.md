...
- SSRM-3D tool-making, social-pressure, social-ecology, social trust/contracts, and predator/threat testing showing that external tools, identity memory, reputation, commitments, costly signals, and threat defenses are selected only when they preserve future options.
