...
- SSRM-3D tool-making, social-pressure, social-ecology, social trust/contracts, predator/threat, and resource-ecology testing showing that external tools, identity memory, reputation, commitments, costly signals, threat defenses, caches, restraint, and territory are selected only when they preserve future options.
