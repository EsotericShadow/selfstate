...
- discovered affordances rather than assigned jobs;
...
Resources are farther apart and visually distinct. The viewer now shows terrain patches, forest props, mineral rocks, frontier formations, shelter differences, life reserve, cell-repair debt, carrying state, dependents, births, sound field, and per-agent inferred specializations.
