...
- reports now include Report `123`, with roadmap docs through `102`;
- the canonical runner is wired for `103` executable runs;
- the newest evidence step is a bounded minimum-channel planning pass: a dynamic weakest-channel planner around learned action heads gets held-out crisis score `0.590`, resolved rate `0.878`, and coupled response `0.828`;
